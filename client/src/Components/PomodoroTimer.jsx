...
export const PomodoroTimer = () => {
  ...
  const segmentStyle = {
    ...
    border: '2px solid black', // Border between segments
    background: completedCycles >= 1 ? 'green' : 'transparent' // Change background color of completed segments
  };

  return (
    <div className="timer-container"> 
      <div className="timer-title alice-regular">
        TIMER
      </div>
      ...
      <div className='timer-container2'>
        <div className="timer coiny-regular" style={timerStyle}>{`${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`}</div>
